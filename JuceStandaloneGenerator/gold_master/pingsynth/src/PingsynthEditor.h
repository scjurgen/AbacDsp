    ...
    void resized() override
    {
        ...
        }
        {
            ...
            box.items.add(juce::FlexItem(typeDrop)
                              ...
                              .withAlignSelf(juce::FlexItem::AlignSelf::stretch)
                              .withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(xDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(yDial).withFlex(1).withMargin(knobMarginSmall));
            ...
            box.items.add(juce::FlexItem(decaySkewDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(spreadDial).withFlex(1).withMargin(knobMarginSmall));
        ...
        }
        {
            ...
            box.flexDirection = juce::FlexBox::Direction::column;
            box.justifyContent = juce::FlexBox::JustifyContent::spaceAround;
            box.items.add(juce::FlexItem(skewDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(SpreadDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(randPowerDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(randExcitationDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(sparkleTimeDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(sparkleRandDial).withFlex(1).withMargin(knobMarginSmall));
        ...
        }
        {
            ...
            box.flexDirection = juce::FlexBox::Direction::column;
            box.justifyContent = juce::FlexBox::JustifyContent::spaceAround;
            box.items.add(juce::FlexItem(softExcitationDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(minHarmonicsDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(maxHarmonicsDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(minPbNoteDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(maxPbNoteDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(rangePbDial).withFlex(1).withMargin(knobMarginSmall));
...
#pragma GCC diagnostic pop
    ...
    void initWidgets()
    {
        ...
        addAndMakeVisible(xDial);
        xDial.reset(valueTreeState, "x");
        xDial.setLabelText(juce::String::fromUTF8("X"));
        addAndMakeVisible(yDial);
        yDial.reset(valueTreeState, "y");
        yDial.setLabelText(juce::String::fromUTF8("Y"));
        ...
        addAndMakeVisible(decaySkewDial);
        decaySkewDial.reset(valueTreeState, "decaySkew");
        decaySkewDial.setLabelText(juce::String::fromUTF8("Decay Skew"));
        addAndMakeVisible(spreadDial);
        spreadDial.reset(valueTreeState, "spread");
        spreadDial.setLabelText(juce::String::fromUTF8("Spread"));
        ...
        addAndMakeVisible(skewDial);
        skewDial.reset(valueTreeState, "skew");
        skewDial.setLabelText(juce::String::fromUTF8("Skew Factor"));
        addAndMakeVisible(SpreadDial);
        SpreadDial.reset(valueTreeState, "Spread");
        SpreadDial.setLabelText(juce::String::fromUTF8("Rand Spread"));
        addAndMakeVisible(randPowerDial);
        randPowerDial.reset(valueTreeState, "randPower");
        randPowerDial.setLabelText(juce::String::fromUTF8("Rand Power"));
        addAndMakeVisible(randExcitationDial);
        randExcitationDial.reset(valueTreeState, "randExcitation");
        randExcitationDial.setLabelText(juce::String::fromUTF8("Rand Excitation"));
        addAndMakeVisible(softExcitationDial);
        softExcitationDial.reset(valueTreeState, "softExcitation");
        softExcitationDial.setLabelText(juce::String::fromUTF8("Soft Excitation"));
        addAndMakeVisible(sparkleTimeDial);
        sparkleTimeDial.reset(valueTreeState, "sparkleTime");
        sparkleTimeDial.setLabelText(juce::String::fromUTF8("Sparkle Time"));
        addAndMakeVisible(sparkleRandDial);
        sparkleRandDial.reset(valueTreeState, "sparkleRand");
        sparkleRandDial.setLabelText(juce::String::fromUTF8("Sparkle Rand"));
        addAndMakeVisible(minHarmonicsDial);
        minHarmonicsDial.reset(valueTreeState, "minHarmonics");
        minHarmonicsDial.setLabelText(juce::String::fromUTF8("Min Harmonics"));
        addAndMakeVisible(maxHarmonicsDial);
        maxHarmonicsDial.reset(valueTreeState, "maxHarmonics");
        maxHarmonicsDial.setLabelText(juce::String::fromUTF8("Max Harmonics"));
        addAndMakeVisible(minPbNoteDial);
        minPbNoteDial.reset(valueTreeState, "minPbNote");
        minPbNoteDial.setLabelText(juce::String::fromUTF8("Min PB note"));
        addAndMakeVisible(maxPbNoteDial);
        maxPbNoteDial.reset(valueTreeState, "maxPbNote");
        maxPbNoteDial.setLabelText(juce::String::fromUTF8("Max PB note"));
        addAndMakeVisible(rangePbDial);
        rangePbDial.reset(valueTreeState, "rangePb");
        rangePbDial.setLabelText(juce::String::fromUTF8("Range PB"));
  ...
  private:
    ...
    CustomRotaryDial xDial{this};
    CustomRotaryDial yDial{this};
    CustomRotaryDial attackDial{this};
    CustomRotaryDial decayDial{this};
    CustomRotaryDial decaySkewDial{this};
    CustomRotaryDial spreadDial{this};
    juce::ComboBox typeDrop{};
    std::unique_ptr<juce::AudioProcessorValueTreeState::ComboBoxAttachment> typeDropAttachment;
    CustomRotaryDial skewDial{this};
    CustomRotaryDial SpreadDial{this};
    CustomRotaryDial randPowerDial{this};
    CustomRotaryDial randExcitationDial{this};
    CustomRotaryDial softExcitationDial{this};
    CustomRotaryDial sparkleTimeDial{this};
    CustomRotaryDial sparkleRandDial{this};
    CustomRotaryDial minHarmonicsDial{this};
    CustomRotaryDial maxHarmonicsDial{this};
    CustomRotaryDial minPbNoteDial{this};
    CustomRotaryDial maxPbNoteDial{this};
    CustomRotaryDial rangePbDial{this};
    CpuGauge cpuGauge{};
    Gauge levelGauge{};
