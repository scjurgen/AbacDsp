...
#include "pedals/FDNExplorePedal.h"
...
class AudioPluginAudioProcessor : public juce::AudioProcessor, public juce::AudioProcessorValueTreeState::Listener
{
  public:
        ...
        , m_patchIndex(0, 0)
    {
        ...
        m_parameters.addParameterListener("decayLow", this);
        m_parameters.addParameterListener("crossOver", this);
        m_parameters.addParameterListener("decayHigh", this);
        ...
        m_parameters.addParameterListener("pitchSize", this);
    ...
    ~AudioPluginAudioProcessor() override
    {
        ...
        m_parameters.removeParameterListener("modulationCount", this);
        ...
        m_parameters.removeParameterListener("pitchSize", this);
    ...
    {
        pluginRunner = std::make_unique<FDNExplorePedal<NumSamplesPerBlock>>(RateNormalizer::kInternalSampleRate);
...
#pragma GCC diagnostic ignored "-Wimplicit-float-conversion"
    juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
    {
        ...
        params.push_back(std::make_unique<juce::AudioParameterChoice>(
            ...
            juce::StringArray{"2", "4", "8", "12", "16", "20", "24", "28", "32", "36", "40", "44", "48", "52", "56",
                              "60", "64"},
            8));
        ...
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            ...
            juce::AudioParameterFloatAttributes{}.withLabel("dB").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 1) + " dB"; })));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("lowSize", 1), "Smallest size",
            juce::NormalisableRange<float>(1.0, 600, 0.01, 0.5, false), 10,
            juce::AudioParameterFloatAttributes{}.withLabel("m").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 2) + " m"; })));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("highSize", 1), "Largest size",
            juce::NormalisableRange<float>(1.0, 600, 0.01, 0.5, false), 25,
            juce::AudioParameterFloatAttributes{}.withLabel("m").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 2) + " m"; })));
        params.push_back(
        ...
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("decayLow", 1), "Decay Low", juce::NormalisableRange<float>(0, 100000, 0.1, 0.25, false),
            2000,
        ...
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("decayHigh", 1), "Decay High",
            juce::NormalisableRange<float>(0, 100000, 0.1, 0.25, false), 2000,
            juce::AudioParameterFloatAttributes{}.withLabel("ms").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 1) + " ms"; })));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("allPassUp", 1), "All pass up", juce::NormalisableRange<float>(20, 20000, 1, 0.5, false),
            2000,
            juce::AudioParameterFloatAttributes{}.withLabel("Hz").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 0) + " Hz"; })));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("allPassDown", 1), "All pass down",
            juce::NormalisableRange<float>(20, 20000, 1, 0.5, false), 1000,
            juce::AudioParameterFloatAttributes{}.withLabel("Hz").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 0) + " Hz"; })));
        params.push_back(std::make_unique<juce::AudioParameterChoice>(
        ...
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            ...
            juce::AudioParameterFloatAttributes{}.withLabel("st").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 2) + " st"; })));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("pitchSize", 1), "Pitchsize", juce::NormalisableRange<float>(20, 20000, 0.1, 0.25, false),
            500,
            juce::AudioParameterFloatAttributes{}.withLabel("ms").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 1) + " ms"; })));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("pitch1", 1), "Pitch 1", juce::NormalisableRange<float>(-24, 24, 0.01, 1, false), 0,
            juce::AudioParameterFloatAttributes{}.withLabel("").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 2) + " "; })));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            ...
            juce::AudioParameterFloatAttributes{}.withLabel("").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 2) + " "; })));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("pitch3", 1), "Pitch 3", juce::NormalisableRange<float>(-24, 24, 0.01, 1, false), 0,
            juce::AudioParameterFloatAttributes{}.withLabel("").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 2) + " "; })));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("pitch4", 1), "Pitch 4", juce::NormalisableRange<float>(-24, 24, 0.01, 1, false), 0,
            juce::AudioParameterFloatAttributes{}.withLabel("").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 2) + " "; })));
...
#pragma GCC diagnostic pop
    ...
    void parameterChanged(const juce::String& parameterID, float newValue) override
    {
        ...
        static const std::map<juce::String, std::function<void(AudioPluginAudioProcessor&, float)>> parameterMap{
            ...
            {"lowSize",
             [](AudioPluginAudioProcessor& p, const float v)
             {
                 p.pluginRunner->setLowSize(v);
                 p.m_fileIo.updateParameter(PatchParameters::Id::lowSize, v);
             }},
            {"highSize",
             [](AudioPluginAudioProcessor& p, const float v)
             {
                 p.pluginRunner->setHighSize(v);
                 p.m_fileIo.updateParameter(PatchParameters::Id::highSize, v);
             }},
            {"uniqueDelay",
             [](AudioPluginAudioProcessor& p, const float v)
             {
            ...
            {"decayLow",
             [](AudioPluginAudioProcessor& p, const float v)
             {
                 p.pluginRunner->setDecayLow(v);
                 p.m_fileIo.updateParameter(PatchParameters::Id::decayLow, v);
             }},
            {"crossOver",
             [](AudioPluginAudioProcessor& p, const float v)
             {
            ...
            {"decayHigh",
             [](AudioPluginAudioProcessor& p, const float v)
             {
                 p.pluginRunner->setDecayHigh(v);
                 p.m_fileIo.updateParameter(PatchParameters::Id::decayHigh, v);
             }},
            {"allPassUp",
             [](AudioPluginAudioProcessor& p, const float v)
             {
            ...
            {"allPassCount",
             [](AudioPluginAudioProcessor& p, const float v)
             {
                 p.pluginRunner->setAllPassCount(static_cast<int>(v));
                 p.m_fileIo.updateParameter(PatchParameters::Id::allPassCount, v);
             }},
            {"lowPass",
             [](AudioPluginAudioProcessor& p, const float v)
             {
            ...
            {"modulationCount",
             [](AudioPluginAudioProcessor& p, const float v)
             {
                 p.pluginRunner->setModulationCount(static_cast<int>(v));
                 p.m_fileIo.updateParameter(PatchParameters::Id::modulationCount, v);
             }},
            {"reversePitch",
             [](AudioPluginAudioProcessor& p, const float v)
             {
            ...
            {"pitchSize",
             [](AudioPluginAudioProcessor& p, const float v)
             {
                 p.pluginRunner->setPitchSize(v);
                 p.m_fileIo.updateParameter(PatchParameters::Id::pitchSize, v);
             }},
            {"pitch1",
             [](AudioPluginAudioProcessor& p, const float v)
             {
    ...
    void applyLoadedParametersToHost()
    {
        ...
        if (auto* p = m_parameters.getParameter("lowSize"))
        {
            const auto& range = m_parameters.getParameterRange("lowSize");
            float normalized = range.convertTo0to1(params.lowSize);
            p->setValueNotifyingHost(normalized);
        }
        if (auto* p = m_parameters.getParameter("highSize"))
        {
            const auto& range = m_parameters.getParameterRange("highSize");
            float normalized = range.convertTo0to1(params.highSize);
            p->setValueNotifyingHost(normalized);
        }
        ...
        if (auto* p = m_parameters.getParameter("decayLow"))
        {
            const auto& range = m_parameters.getParameterRange("decayLow");
            float normalized = range.convertTo0to1(params.decayLow);
            p->setValueNotifyingHost(normalized);
        }
        ...
        if (auto* p = m_parameters.getParameter("decayHigh"))
        {
            const auto& range = m_parameters.getParameterRange("decayHigh");
            float normalized = range.convertTo0to1(params.decayHigh);
            p->setValueNotifyingHost(normalized);
        }
        ...
        if (auto* p = m_parameters.getParameter("allPassCount"))
        {
            const auto& range = m_parameters.getParameterRange("allPassCount");
            float normalized = range.convertTo0to1(params.allPassCount);
            p->setValueNotifyingHost(normalized);
        }
        ...
        if (auto* p = m_parameters.getParameter("modulationCount"))
        {
            const auto& range = m_parameters.getParameterRange("modulationCount");
            float normalized = range.convertTo0to1(params.modulationCount);
            p->setValueNotifyingHost(normalized);
        }
        ...
        if (auto* p = m_parameters.getParameter("pitchSize"))
        {
            const auto& range = m_parameters.getParameterRange("pitchSize");
            float normalized = range.convertTo0to1(params.pitchSize);
            p->setValueNotifyingHost(normalized);
        }
...
#pragma GCC diagnostic pop
  ...
  private:
    ...
    std::unique_ptr<FDNExplorePedal<NumSamplesPerBlock>> pluginRunner;
