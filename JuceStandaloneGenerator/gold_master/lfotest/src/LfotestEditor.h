...
#pragma GCC diagnostic ignored "-Wfloat-conversion"
    void resized() override
    {
        ...
        const auto colWidth = area.getWidth() / 19;
        areas[0] = area.removeFromLeft(colWidth * 1).reduced(Constants::Margins::small);
        areas[1] = area.removeFromLeft(colWidth * 3).reduced(Constants::Margins::small);
        areas[2] = area.removeFromLeft(colWidth * 3).reduced(Constants::Margins::small);
        ...
        }
        {
            ...
            box.flexDirection = juce::FlexBox::Direction::column;
            box.justifyContent = juce::FlexBox::JustifyContent::spaceAround;
            box.items.add(juce::FlexItem(waveDrop)
                              .withFlex(0)
                              .withHeight(Constants::Text::labelHeight)
                              .withAlignSelf(juce::FlexItem::AlignSelf::stretch)
                              .withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(frequencyDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(deformTypeDrop)
                              .withFlex(0)
                              .withHeight(Constants::Text::labelHeight)
                              .withAlignSelf(juce::FlexItem::AlignSelf::stretch)
                              .withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(deformDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(gainDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(clipDial).withFlex(1).withMargin(knobMarginSmall));
        ...
        }
        {
            ...
            box.flexDirection = juce::FlexBox::Direction::column;
            box.justifyContent = juce::FlexBox::JustifyContent::spaceAround;
            box.items.add(juce::FlexItem(offsetDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(phaseDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(smoothDial).withFlex(1).withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(outputTypeDrop)
                              .withFlex(0)
                              .withHeight(Constants::Text::labelHeight)
                              .withAlignSelf(juce::FlexItem::AlignSelf::stretch)
                              .withMargin(knobMarginSmall));
            box.items.add(juce::FlexItem(discreteDial).withFlex(1).withMargin(knobMarginSmall));
...
#pragma GCC diagnostic pop
    ...
    void initWidgets()
    {
        addAndMakeVisible(waveDrop);
        waveDrop.addItemList(valueTreeState.getParameter("wave")->getAllValueStrings(), 1);
        waveDropAttachment =
            std::make_unique<juce::AudioProcessorValueTreeState::ComboBoxAttachment>(valueTreeState, "wave", waveDrop);
        ...
        frequencyDial.reset(valueTreeState, "frequency");
        frequencyDial.setLabelText(juce::String::fromUTF8("Frequency"));
        addAndMakeVisible(deformTypeDrop);
        deformTypeDrop.addItemList(valueTreeState.getParameter("deformType")->getAllValueStrings(), 1);
        deformTypeDropAttachment = std::make_unique<juce::AudioProcessorValueTreeState::ComboBoxAttachment>(
            valueTreeState, "deformType", deformTypeDrop);
        addAndMakeVisible(deformDial);
        deformDial.reset(valueTreeState, "deform");
        deformDial.setLabelText(juce::String::fromUTF8("Deform"));
        addAndMakeVisible(gainDial);
        gainDial.reset(valueTreeState, "gain");
        gainDial.setLabelText(juce::String::fromUTF8("Gain"));
        addAndMakeVisible(offsetDial);
        offsetDial.reset(valueTreeState, "offset");
        offsetDial.setLabelText(juce::String::fromUTF8("Offset"));
        addAndMakeVisible(clipDial);
        clipDial.reset(valueTreeState, "clip");
        clipDial.setLabelText(juce::String::fromUTF8("Clip"));
        addAndMakeVisible(phaseDial);
        phaseDial.reset(valueTreeState, "phase");
        phaseDial.setLabelText(juce::String::fromUTF8("Phase"));
        addAndMakeVisible(smoothDial);
        smoothDial.reset(valueTreeState, "smooth");
        smoothDial.setLabelText(juce::String::fromUTF8("Smooth"));
        addAndMakeVisible(outputTypeDrop);
        outputTypeDrop.addItemList(valueTreeState.getParameter("outputType")->getAllValueStrings(), 1);
        outputTypeDropAttachment = std::make_unique<juce::AudioProcessorValueTreeState::ComboBoxAttachment>(
            valueTreeState, "outputType", outputTypeDrop);
        addAndMakeVisible(discreteDial);
        discreteDial.reset(valueTreeState, "discrete");
        discreteDial.setLabelText(juce::String::fromUTF8("Discrete"));
  ...
  private:
    ...
    juce::ComboBox waveDrop{};
    std::unique_ptr<juce::AudioProcessorValueTreeState::ComboBoxAttachment> waveDropAttachment;
    CustomRotaryDial volDial{this};
    CustomRotaryDial frequencyDial{this};
    juce::ComboBox deformTypeDrop{};
    std::unique_ptr<juce::AudioProcessorValueTreeState::ComboBoxAttachment> deformTypeDropAttachment;
    CustomRotaryDial deformDial{this};
    CustomRotaryDial gainDial{this};
    CustomRotaryDial offsetDial{this};
    CustomRotaryDial clipDial{this};
    CustomRotaryDial phaseDial{this};
    CustomRotaryDial smoothDial{this};
    juce::ComboBox outputTypeDrop{};
    std::unique_ptr<juce::AudioProcessorValueTreeState::ComboBoxAttachment> outputTypeDropAttachment;
    CustomRotaryDial discreteDial{this};
    CpuGauge cpuGauge{};
    Gauge levelGauge{};
