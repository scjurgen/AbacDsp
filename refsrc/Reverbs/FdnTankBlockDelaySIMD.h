...
/**
 * @ingroup reverbs
 * @brief Block-processed FDN mixing through the flat SIMD Hadamard, hadamardFeedN_simd().
 *
 ...
 *
 * Each output row is a masked multiply and a horizontal add. Still order-squared
 * work, but the lanes hide most of it.
 */
