...
class VariReaderTest : public ::testing::Test
{
  protected:
    ...
    AbacDsp::VariReader<BufferSize> reader{48000.f, filter};
...
using testedBuffer = VariReaderTest<1480000>;

TEST_F(testedBuffer, CheckRatioOfProduction)
{
...
TEST_F(testedBuffer, checkDelta)
{
    constexpr size_t frames = 32; // input frames
    ...
    const std::vector<TestValues> testValues{{1.0f, 22}, {1.2f, 27}, {0.8f, 22}, {3.3f, 75},  {4.0f, 91},
                                             {2.0f, 45}, {2.1f, 47}, {0.5f, 21}, {0.222f, 20}};
