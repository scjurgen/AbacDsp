...
#include "DSP/Filter/OnePoleFilter.h"
#include "DSP/Synthesiser/OrnsteinUhlenbeckProcess_test.h"
...
class Wow
{
  ...
  private:
    ...
    OnePoleFilter<FilterOnePoleCharacteristic::LowPass> m_lowpass;
    OnePoleFilter<FilterOnePoleCharacteristic::LowPass> m_depthLowpass;
    OrnsteinUhlenbeckProcess_test m_ouProcess;
