...
public:
  ...
  void setAllPass(const float value) { m_allPass = value; }
  void setModDepth(const float value) { m_modDepth = value; }
  void setModSpeed(const float value) { m_modSpeed = value; }
