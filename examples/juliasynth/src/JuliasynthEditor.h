...
#pragma GCC diagnostic ignored "-Wfloat-conversion"
  void resized() override {
    ...
    }
    {
      ...
      box.justifyContent = juce::FlexBox::JustifyContent::spaceAround;
      box.items.add(
          juce::FlexItem(cxDial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(cyDial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(jxDial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(jyDial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(jrxDial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(jryDial).withFlex(1).withMargin(knobMarginSmall));
