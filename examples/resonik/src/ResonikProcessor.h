...
#pragma GCC diagnostic ignored "-Wimplicit-float-conversion"
    juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
    {
        ...
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("numChains", 1), juce::String::fromUTF8("Chains"),
            juce::NormalisableRange<float>(1, 100, 1, 0.5, false), 48,
...
#pragma GCC diagnostic pop
    ...
    void applyLoadedParametersToHost()
    {
        ...
        if (auto* p = m_parameters.getParameter("numChains"))
        {
            ...
            float normalized = range.convertTo0to1(static_cast<float>(params.numChains));
