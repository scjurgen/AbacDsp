...
public:
  ...
  void setOrder(const size_t value) { m_order = value; }
  void setDry(const float value) { m_dry = std::pow(10.f, value / 20.f); }
  void setWet(const float value) { m_wet = std::pow(10.f, value / 20.f); }
  void setStereoWidth(const float value) { m_stereoWidth = value; }
  void setBaseSize(const float value) { m_baseSize = value; }
  void setSizeFactor(const float value) { m_sizeFactor = value; }
  void setBulge(const float value) { m_bulge = value; }
  void setUniqueDelay(const bool value) { m_uniqueDelay = value; }
  void setDecay(const float value) { m_decay = value; }
  void setAllPassUp(const float value) { m_allPassUp = value; }
  void setAllPassDown(const float value) { m_allPassDown = value; }
  void setLowPass(const float value) { m_lowPass = value; }
  void setLowPassCount(const size_t value) { m_lowPassCount = value; }
  void setHighPass(const float value) { m_highPass = value; }
  void setHighPassCount(const size_t value) { m_highPassCount = value; }
  ...
  void setReversePitch(const bool value) { m_reversePitch = value; }
  void setPitchStrength(const float value) { m_pitchStrength = value; }
  void setPitch1Inplace(const float value) { m_pitch1Inplace = value; }
  void setPitch2Inplace(const float value) { m_pitch2Inplace = value; }
