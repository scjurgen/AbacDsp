...
// Hand-written, pathfinder-only glue between LuaControlArea (a shared, generic template) and
// the script macros PathfinderScriptEngine offers as knobs. Not in CPP_SOURCE_FILES_FIXED, so
...
[[nodiscard]] inline std::vector<LuaControlDescriptor> toLuaControlDescriptors(const PathfinderKnobSlots& slots)
{
