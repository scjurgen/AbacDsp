...
#include "MorphexsynthProcessor.h"
...
#pragma GCC diagnostic pop
    ...
    void initWidgets()
    {
        ...
        cutoffDial.setTooltip(juce::String::fromUTF8("Cutoff (0 to 127)"));
    ...
    void showAboutDialog()
    {
        ...
        const juce::String body =
            ...
            "\n\n"
            "MPE subtractive synth: three oscillators through a resonant filter, with a 10-slot MPE routing matrix, "
...
#ifdef MORPHEXSYNTH_SCRIPTING_DOCS_FILE
        editorComponent->onOpenDocs = []
        { juce::URL(juce::File(MORPHEXSYNTH_SCRIPTING_DOCS_FILE)).launchInDefaultBrowser(); };
