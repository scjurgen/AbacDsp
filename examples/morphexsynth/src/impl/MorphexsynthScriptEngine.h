...
"-- import \"constants\" gives named tables for the enum fields below (OscWaveform,\n"
"-- LfoWaveform, CtrlSource, CtrlCurve, CtrlValueType, CtrlTarget) instead of bare\n"
"-- numbers - see base-scripts/constants.lua.\n"
"\n"
