...
class AudioPluginAudioProcessor : public juce::AudioProcessor, public juce::AudioProcessorValueTreeState::Listener
{
  public:
        ...
        , m_patchIndex(0, 0)
    {
        ...
        m_parameters.addParameterListener("filterType", this);
    ...
    ~AudioPluginAudioProcessor() override
    {
        ...
        m_parameters.removeParameterListener("filterType", this);
    ...
    {
        pluginRunner = std::make_unique<AmbientSynthImpl<NumSamplesPerBlock>>(RateNormalizer::kInternalSampleRate);
    ...
    juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
    {
        ...
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            ...
            juce::AudioParameterFloatAttributes{}.withLabel("").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 2) + " "; })));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
            juce::ParameterID("resonance", 1), juce::String::fromUTF8("Resonance"),
            juce::NormalisableRange<float>(0, 1, 0.01, 1, false), 0.1,
            juce::AudioParameterFloatAttributes{}.withLabel("").withStringFromValueFunction(
                [](float value, int) { return juce::String(value, 2) + " "; })));
        params.push_back(std::make_unique<juce::AudioParameterChoice>(
            juce::ParameterID("filterType", 1), juce::String::fromUTF8("Filter"),
            juce::StringArray{juce::String::fromUTF8("LP4"), juce::String::fromUTF8("LP2"),
                              juce::String::fromUTF8("LP1Notch"), juce::String::fromUTF8("Notch"),
                              juce::String::fromUTF8("BP2"), juce::String::fromUTF8("HP1LP3"),
                              juce::String::fromUTF8("AP4")},
            0));
        params.push_back(std::make_unique<juce::AudioParameterFloat>(
...
#pragma GCC diagnostic pop
    ...
    void parameterChanged(const juce::String& parameterID, float newValue) override
    {
        ...
        static const std::map<juce::String, std::function<void(AudioPluginAudioProcessor&, float)>> parameterMap{
            ...
            {"filterType",
             [](AudioPluginAudioProcessor& p, const float v)
             {
                 p.pluginRunner->setFilterType(static_cast<int>(v));
                 p.m_fileIo.updateParameter(PatchParameters::Id::filterType, v);
             }},
            {"bloom",
             [](AudioPluginAudioProcessor& p, const float v)
             {
    ...
    void applyLoadedParametersToHost()
    {
        ...
        if (auto* p = m_parameters.getParameter("filterType"))
        {
            const auto& range = m_parameters.getParameterRange("filterType");
            float normalized = range.convertTo0to1(static_cast<float>(params.filterType));
            p->setValueNotifyingHost(normalized);
        }
...
#pragma GCC diagnostic pop
    ...
    [[nodiscard]] AmbientSynthScriptEngine::UiParamSlots getLuaUiParamSlots() const
    {
        return pluginRunner ? pluginRunner->uiParamSlots() : AmbientSynthScriptEngine::UiParamSlots{};
    }
    [[nodiscard]] std::array<AbacDsp::AmbientSynthVoice::ModulationSnapshot, 16> getVoiceSnapshots() const noexcept
    {
        return pluginRunner ? pluginRunner->getVoiceSnapshots()
                            : std::array<AbacDsp::AmbientSynthVoice::ModulationSnapshot, 16>{};
    }
  ...
  private:
    ...
    std::unique_ptr<AmbientSynthImpl<NumSamplesPerBlock>> pluginRunner;
