...
#pragma GCC diagnostic ignored "-Wfloat-conversion"
  void resized() override {
...

    {
      ...
      box.items.add(juce::FlexItem(reverbLevelWetDial)
                        .withFlex(1)
                        .withMargin(knobMarginSmall));
      box.items.add(juce::FlexItem(reverbDecayDial)
                        .withFlex(1)
                        .withMargin(knobMarginSmall));
      box.items.add(juce::FlexItem(reverbShimmerDial)
                        .withFlex(1)
                        .withMargin(knobMarginSmall));
    ...
    }
    {
      ...
      box.justifyContent = juce::FlexBox::JustifyContent::spaceAround;
      box.items.add(
          juce::FlexItem(vol1Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(vol2Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(vol3Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(vol4Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(vol5Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(vol6Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(vol7Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(vol8Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(vol9Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(vol10Dial).withFlex(1).withMargin(knobMarginSmall));
    ...
    }
    {
      ...
      box.justifyContent = juce::FlexBox::JustifyContent::spaceAround;
      box.items.add(
          juce::FlexItem(pitch1Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(pitch2Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(pitch3Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(pitch4Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(pitch5Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(pitch6Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(pitch7Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(pitch8Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(pitch9Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(pitch10Dial).withFlex(1).withMargin(knobMarginSmall));
    ...
    }
    {
      ...
      box.justifyContent = juce::FlexBox::JustifyContent::spaceAround;
      box.items.add(
          juce::FlexItem(revFeed1Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(revFeed2Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(revFeed3Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(revFeed4Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(revFeed5Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(revFeed6Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(revFeed7Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(revFeed8Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(
          juce::FlexItem(revFeed9Dial).withFlex(1).withMargin(knobMarginSmall));
      box.items.add(juce::FlexItem(revFeed10Dial)
                        .withFlex(1)
                        .withMargin(knobMarginSmall));
  ...
  void initWidgets() {
    ...
    syncSwitchAttachment =
        std::make_unique<juce::AudioProcessorValueTreeState::ButtonAttachment>(
            valueTreeState, "sync", syncSwitch);
    ...
    soloDrop.addItemList(
        valueTreeState.getParameter("solo")->getAllValueStrings(), 1);
    soloDropAttachment = std::make_unique<
        juce::AudioProcessorValueTreeState::ComboBoxAttachment>(
        valueTreeState, "solo", soloDrop);
