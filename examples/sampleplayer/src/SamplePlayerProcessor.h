...
public:
  ...
  void prepareToPlay(const double sampleRate,
    ...
    pluginRunner = std::make_unique<SamplePlayer<NumSamplesPerBlock>>(
...
#pragma GCC diagnostic ignored "-Wimplicit-float-conversion"
  juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout() {
    ...
    params.push_back(std::make_unique<juce::AudioParameterBool>(
        juce::ParameterID("sync", 1), "Sync", 0));
    params.push_back(std::make_unique<juce::AudioParameterChoice>(
        juce::ParameterID("type", 1), "Type",
        juce::StringArray{"PITCHONLY", "DOLPHINS", "WIND", "RAINFOREST",
                          "FOREST", "RAIN", "THUNDER", "TANPURA", "STREAM",
                          "OCEAN", "BOWLS", "CAFE", "RPGFOREST", "WHITEPULSE"},
        0));
    params.push_back(std::make_unique<juce::AudioParameterChoice>(
    ...
    params.push_back(std::make_unique<juce::AudioParameterChoice>(
        ...
        juce::StringArray{"None", "Track 1", "Track 2", "Track 3", "Track 4",
    ...
    params.push_back(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID("reverbLevelWet", 1), "Reverb Wet",
        juce::NormalisableRange<float>(-120, 0, 1, 1, false), -120,
        juce::String("Reverb Wet"),
