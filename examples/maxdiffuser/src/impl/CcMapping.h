...
inline constexpr std::array<CcMapping, 34> kDefaultCcMappings{{
    {20, -100.0f, 12.0f},  {21, -100.0f, 12.0f},  {22, 0.0f, 1000.0f},   {23, 0.0f, 100.0f},   {40, 0.0f, 100.0f},
...
inline constexpr std::array<CcFullRange, 34> kCcTargetFullRange{{
    {-100.0f, 12.0f},  {-100.0f, 12.0f},  {0.0f, 1000.0f},   {0.0f, 100.0f},  {0.0f, 100.0f},  {-100.0f, 100.0f},
