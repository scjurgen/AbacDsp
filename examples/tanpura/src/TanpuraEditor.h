    ...
    void resized() override
    {
        ...
        area = area.reduced(static_cast<int>(Constants::Margins::big));
        {
            ...
            }
            {
                ...
                box.flexDirection = juce::FlexBox::Direction::column;
                box.justifyContent = juce::FlexBox::JustifyContent::spaceAround;
                box.items.add(juce::FlexItem(detuneString1Dial).withFlex(1).withMargin(knobMarginSmall));
                box.items.add(juce::FlexItem(detuneString2Dial).withFlex(1).withMargin(knobMarginSmall));
                box.items.add(juce::FlexItem(detuneString3Dial).withFlex(1).withMargin(knobMarginSmall));
                box.items.add(juce::FlexItem(detuneString4Dial).withFlex(1).withMargin(knobMarginSmall));
                box.items.add(juce::FlexItem(detuneString5Dial).withFlex(1).withMargin(knobMarginSmall));
            ...
            }
            {
                ...
                box.flexDirection = juce::FlexBox::Direction::column;
                box.justifyContent = juce::FlexBox::JustifyContent::spaceAround;
                box.items.add(juce::FlexItem(picksPerMinuteDial).withFlex(1).withMargin(knobMarginSmall));
                box.items.add(juce::FlexItem(pauseLengthDial).withFlex(1).withMargin(knobMarginSmall));
...
#pragma GCC diagnostic pop
    ...
    void initWidgets()
    {
        ...
        addAndMakeVisible(detuneString1Dial);
        detuneString1Dial.reset(valueTreeState, "detuneString1");
        detuneString1Dial.setLabelText(juce::String::fromUTF8("Detune 1"));
        addAndMakeVisible(detuneString2Dial);
        detuneString2Dial.reset(valueTreeState, "detuneString2");
        detuneString2Dial.setLabelText(juce::String::fromUTF8("Detune 2"));
        addAndMakeVisible(detuneString3Dial);
        detuneString3Dial.reset(valueTreeState, "detuneString3");
        detuneString3Dial.setLabelText(juce::String::fromUTF8("Detune 3"));
        addAndMakeVisible(detuneString4Dial);
        detuneString4Dial.reset(valueTreeState, "detuneString4");
        detuneString4Dial.setLabelText(juce::String::fromUTF8("Detune 4"));
        addAndMakeVisible(detuneString5Dial);
        detuneString5Dial.reset(valueTreeState, "detuneString5");
        detuneString5Dial.setLabelText(juce::String::fromUTF8("Detune 5"));
        ...
        addAndMakeVisible(picksPerMinuteDial);
        picksPerMinuteDial.reset(valueTreeState, "picksPerMinute");
        picksPerMinuteDial.setLabelText(juce::String::fromUTF8("Picks/M"));
        addAndMakeVisible(pauseLengthDial);
        pauseLengthDial.reset(valueTreeState, "pauseLength");
        pauseLengthDial.setLabelText(juce::String::fromUTF8("Pause"));
  ...
  private:
    ...
    CustomRotaryDial detuneString1Dial{this};
    CustomRotaryDial detuneString2Dial{this};
    CustomRotaryDial detuneString3Dial{this};
    CustomRotaryDial detuneString4Dial{this};
    CustomRotaryDial detuneString5Dial{this};
    ...
    CustomRotaryDial picksPerMinuteDial{this};
    CustomRotaryDial pauseLengthDial{this};
