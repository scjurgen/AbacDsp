...
#pragma GCC diagnostic pop
    ...
    void showAboutDialog()
    {
        ...
        const juce::String body =
            ...
            "\n\n"
            "A Lua-scripted multitap delay: each of up to 24 taps is a timed, panned, spectrally-shaped voice "
            "(bandpass/lowpass/highpass, notch, resonator, formant or comb resonator), fed off one shared delay "
...
#ifdef SPECTRALTAP_SCRIPTING_DOCS_FILE
        editorComponent->onOpenDocs = []
        { juce::URL(juce::File(SPECTRALTAP_SCRIPTING_DOCS_FILE)).launchInDefaultBrowser(); };
