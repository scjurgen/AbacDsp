    ...
    void resized() override
    {
        ...
        if (m_currentPage == Page::Performance)
        {
...

            {
                ...
                box.items.add(juce::FlexItem(stabilityDial).withFlex(1).withMargin(knobMarginSmall));
...
#pragma GCC diagnostic pop
    ...
    void initWidgets()
    {
        ...
        addAndMakeVisible(noteDial);
        noteDial.reset(valueTreeState, "note");
        noteDial.setLabelText(juce::String::fromUTF8("Note"));
        noteDial.setTooltip(juce::String::fromUTF8("Note (0 to 127)"));
        ...
        lightDial.setTooltip(juce::String::fromUTF8("Light (0 to 1)"));
        addAndMakeVisible(motionDial);
        motionDial.reset(valueTreeState, "motion");
        motionDial.setLabelText(juce::String::fromUTF8("Motion"));
        motionDial.setTooltip(juce::String::fromUTF8("Motion (0 to 1)"));
        addAndMakeVisible(breathDial);
        breathDial.reset(valueTreeState, "breath");
        breathDial.setLabelText(juce::String::fromUTF8("Breath"));
        breathDial.setTooltip(juce::String::fromUTF8("Breath (0 to 1)"));
        addAndMakeVisible(stabilityDial);
        stabilityDial.reset(valueTreeState, "stability");
        stabilityDial.setLabelText(juce::String::fromUTF8("Stability"));
        stabilityDial.setTooltip(juce::String::fromUTF8("Stability (0 to 1)"));
    ...
    void showAboutDialog()
    {
        ...
        const juce::String body =
            ...
            "\n\n"
            "Ambient pad voice: two morphing wavetable layers through a pole-mixing filter, kept alive by correlated "
            "Ornstein-Uhlenbeck modulation instead of a conventional LFO/ADSR matrix. No MIDI input - played from the "
            "Note/Play controls or scripted via Lua.\n\nPart of the AbacDsp project - core DSP library is MIT "
...
#ifdef AMBIENTPAD_SCRIPTING_DOCS_FILE
        editorComponent->onOpenDocs = []
        { juce::URL(juce::File(AMBIENTPAD_SCRIPTING_DOCS_FILE)).launchInDefaultBrowser(); };
  ...
  private:
    ...
    CustomRotaryDial noteDial{this};
    ...
    CustomRotaryDial stabilityDial{this};
