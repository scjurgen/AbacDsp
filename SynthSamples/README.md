...
Rendered synth-patch WAV files (source material for ear-matching patches on other
synths), plus a small analysis tool.
...
.venv/bin/python analyze_sample.py "4 ever mini.wav"
```
