...
- `Audio/` — Generic Audio handling, Buffers
- `AudioFile/` — Wave and Ogg file handling
- `BlockProcessors/` — Thin layers for common processing tasks
...
- `Helpers/` — Construct arrays, Platform intrinsics
...
- `Reverbs/` — FDN with Hadamard mixing; 4/8/16/32 delay line variants, modulated and smooth adaption of reverb delay lines
- `Sampler/` — Sampling, Sequencer
- `Spectral/` — Spectral processing with FFT
