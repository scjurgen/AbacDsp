...
Keep documentation always concise and precise. Prefer usage of ASCII (except when using math formulas). 
Don't overuse bold, the reader should not be forced in a mental model that is driven by bold text.
