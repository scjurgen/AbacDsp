...
inline float remezFullCosP10<DomainMinusPiToPi>(float x) noexcept {
    const auto x2 = x * x;
    return (((((-0.000000220f * x2 + 0.000024204f) * x2 + -0.001385892f) * x2 + 0.041659822f) * x2 + -0.499994268f) * x2 + 0.999999222f);
}
...
inline float remezFullCosP10<DomainMinusOneToOne>(float x) noexcept {
    const auto x2 = x * x;
    return (((((-0.020582795f * x2 + 0.229664214f) * x2 + -1.332381204f) * x2 + 4.058045414f) * x2 + -4.934745629f) * x2 + 0.999999222f);
}
...
inline float remezFullCosAbsFoldP6<DomainMinusPiToPi>(float x) noexcept {
    const auto ax = std::abs(x);
    return ((((((-0.000000000f * ax + -0.007514377f) * ax + 0.059017780f) * ax + -0.019736746f) * ax + -0.489474921f) * ax + -0.002091162f) * ax + 1.000067706f);
}
...
inline float remezFullCosAbsFoldP6<DomainMinusOneToOne>(float x) noexcept {
    const auto ax = std::abs(x);
    return ((((((-0.000000002f * ax + -2.299547329f) * ax + 5.748868331f) * ax + -0.611962999f) * ax + -4.830923835f) * ax + -0.006569579f) * ax + 1.000067706f);
}
