...
/// @ingroup reverbs
/// @brief Unnormalised order-32 Hadamard mix via the fast Walsh-Hadamard butterfly.
/// 5 stages of pairwise add/subtract at doubling stride: 160 adds against 1024 for the flat form.
/// Produces exactly the same matrix and row order as hadamardFeed32(), only faster.
...
/// @ingroup reverbs
/// @brief SIMD form of hadamardWalsh32(), each butterfly stage as a shuffle and a signed add.
inline void hadamardWalsh32_simd(const float* input, float* output) noexcept
{
    ...
    const simd_float4 v4 = simd_make_float4(input[16], input[17], input[18], input[19]);
    const simd_float4 v5 = simd_make_float4(input[20], input[21], input[22], input[23]);
    const simd_float4 v6 = simd_make_float4(input[24], input[25], input[26], input[27]);
    const simd_float4 v7 = simd_make_float4(input[28], input[29], input[30], input[31]);
    ...
    const simd_float4 t1_4 = simd_make_float4(v4.x + v4.y, v4.x - v4.y, v4.z + v4.w, v4.z - v4.w);
    const simd_float4 t1_5 = simd_make_float4(v5.x + v5.y, v5.x - v5.y, v5.z + v5.w, v5.z - v5.w);
    const simd_float4 t1_6 = simd_make_float4(v6.x + v6.y, v6.x - v6.y, v6.z + v6.w, v6.z - v6.w);
    const simd_float4 t1_7 = simd_make_float4(v7.x + v7.y, v7.x - v7.y, v7.z + v7.w, v7.z - v7.w);
    ...
    const simd_float4 t2_4 = simd_make_float4(t1_4.x + t1_4.z, t1_4.y + t1_4.w, t1_4.x - t1_4.z, t1_4.y - t1_4.w);
    const simd_float4 t2_5 = simd_make_float4(t1_5.x + t1_5.z, t1_5.y + t1_5.w, t1_5.x - t1_5.z, t1_5.y - t1_5.w);
    const simd_float4 t2_6 = simd_make_float4(t1_6.x + t1_6.z, t1_6.y + t1_6.w, t1_6.x - t1_6.z, t1_6.y - t1_6.w);
    const simd_float4 t2_7 = simd_make_float4(t1_7.x + t1_7.z, t1_7.y + t1_7.w, t1_7.x - t1_7.z, t1_7.y - t1_7.w);
    ...
    const simd_float4 t3_4 = t2_4 + t2_5;
    const simd_float4 t3_5 = t2_4 - t2_5;
    const simd_float4 t3_6 = t2_6 + t2_7;
    const simd_float4 t3_7 = t2_6 - t2_7;

    // Stage 4: stride 8
    const simd_float4 t4_0 = t3_0 + t3_2;
    const simd_float4 t4_1 = t3_1 + t3_3;
    const simd_float4 t4_2 = t3_0 - t3_2;
    const simd_float4 t4_3 = t3_1 - t3_3;
    const simd_float4 t4_4 = t3_4 + t3_6;
    const simd_float4 t4_5 = t3_5 + t3_7;
    const simd_float4 t4_6 = t3_4 - t3_6;
    const simd_float4 t4_7 = t3_5 - t3_7;

    // Stage 5: stride 16
    const simd_float4 out_0 = t4_0 + t4_4;
    const simd_float4 out_1 = t4_1 + t4_5;
    const simd_float4 out_2 = t4_2 + t4_6;
    const simd_float4 out_3 = t4_3 + t4_7;
    const simd_float4 out_4 = t4_0 - t4_4;
    const simd_float4 out_5 = t4_1 - t4_5;
    const simd_float4 out_6 = t4_2 - t4_6;
    const simd_float4 out_7 = t4_3 - t4_7;
...
inline void hadamardWalsh32_simd(const float* input, float* output) noexcept
{
    ...
    const __m128 v4 = _mm_loadu_ps(&input[16]);
    const __m128 v5 = _mm_loadu_ps(&input[20]);
    const __m128 v6 = _mm_loadu_ps(&input[24]);
    const __m128 v7 = _mm_loadu_ps(&input[28]);
    ...
    add_0 = _mm_add_ps(s2_lo_0, s2_hi_0);
    sub_0 = _mm_sub_ps(s2_lo_0, s2_hi_0);
    const __m128 t2_4 = _mm_shuffle_ps(add_0, sub_0, _MM_SHUFFLE(0, 2, 0, 2));

    s2_lo_0 = _mm_unpacklo_ps(t1_5, t1_5);
    s2_hi_0 = _mm_unpackhi_ps(t1_5, t1_5);
    add_0 = _mm_add_ps(s2_lo_0, s2_hi_0);
    sub_0 = _mm_sub_ps(s2_lo_0, s2_hi_0);
    const __m128 t2_5 = _mm_shuffle_ps(add_0, sub_0, _MM_SHUFFLE(0, 2, 0, 2));

    s2_lo_0 = _mm_unpacklo_ps(t1_6, t1_6);
    s2_hi_0 = _mm_unpackhi_ps(t1_6, t1_6);
    add_0 = _mm_add_ps(s2_lo_0, s2_hi_0);
    sub_0 = _mm_sub_ps(s2_lo_0, s2_hi_0);
    const __m128 t2_6 = _mm_shuffle_ps(add_0, sub_0, _MM_SHUFFLE(0, 2, 0, 2));

    s2_lo_0 = _mm_unpacklo_ps(t1_7, t1_7);
    s2_hi_0 = _mm_unpackhi_ps(t1_7, t1_7);
    add_0 = _mm_add_ps(s2_lo_0, s2_hi_0);
    sub_0 = _mm_sub_ps(s2_lo_0, s2_hi_0);
    const __m128 t2_7 = _mm_shuffle_ps(add_0, sub_0, _MM_SHUFFLE(0, 2, 0, 2));
    ...
    const __m128 t3_4 = _mm_add_ps(t2_4, t2_5);
    const __m128 t3_5 = _mm_sub_ps(t2_4, t2_5);
    const __m128 t3_6 = _mm_add_ps(t2_6, t2_7);
    const __m128 t3_7 = _mm_sub_ps(t2_6, t2_7);

    // Stage 4: stride 8
    const __m128 t4_0 = _mm_add_ps(t3_0, t3_2);
    const __m128 t4_1 = _mm_add_ps(t3_1, t3_3);
    const __m128 t4_2 = _mm_sub_ps(t3_0, t3_2);
    const __m128 t4_3 = _mm_sub_ps(t3_1, t3_3);
    const __m128 t4_4 = _mm_add_ps(t3_4, t3_6);
    const __m128 t4_5 = _mm_add_ps(t3_5, t3_7);
    const __m128 t4_6 = _mm_sub_ps(t3_4, t3_6);
    const __m128 t4_7 = _mm_sub_ps(t3_5, t3_7);

    // Stage 5: stride 16
    const __m128 out_0 = _mm_add_ps(t4_0, t4_4);
    const __m128 out_1 = _mm_add_ps(t4_1, t4_5);
    const __m128 out_2 = _mm_add_ps(t4_2, t4_6);
    const __m128 out_3 = _mm_add_ps(t4_3, t4_7);
    const __m128 out_4 = _mm_sub_ps(t4_0, t4_4);
    const __m128 out_5 = _mm_sub_ps(t4_1, t4_5);
    const __m128 out_6 = _mm_sub_ps(t4_2, t4_6);
    const __m128 out_7 = _mm_sub_ps(t4_3, t4_7);
